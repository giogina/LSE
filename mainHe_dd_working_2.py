...
for term in terms:
    term["admat"] = kron_3d(term["const"][0]*wa,
         A_matrix(a[0], term["a_dep"][0], n_max, n_factor=term["factor_n"]),   # (absorb constant factors into the n_factor)
